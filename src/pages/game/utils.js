...
const poseLMS = {
    ...
    RIGHT_KNEE: pose_1.POSE_LANDMARKS_LEFT.LEFT_KNEE,
    LEFT_KNEE: pose_1.POSE_LANDMARKS_RIGHT.RIGHT_KNEE,
    RIGHT_ANKLE: pose_1.POSE_LANDMARKS_LEFT.LEFT_ANKLE,
    LEFT_ANKLE: pose_1.POSE_LANDMARKS_RIGHT.RIGHT_ANKLE,
};
...
class Star {
    constructor(x, y, functionToCheckActive = () => false, functionToCheckCoordinates = () => [x, y], hasPermanentlyActiveTimer = false, active = false, color = "yellow", permanentlyActive = false, timeToTriggerPermanentlyActive = 0.5 //10
    ) {
        this.activeTime = 0;
