...
const poseLMS = {
	...
	RIGHT_KNEE: POSE_LANDMARKS_LEFT.LEFT_KNEE,
	LEFT_KNEE: POSE_LANDMARKS_RIGHT.RIGHT_KNEE,
	RIGHT_ANKLE: POSE_LANDMARKS_LEFT.LEFT_ANKLE,
	LEFT_ANKLE: POSE_LANDMARKS_RIGHT.RIGHT_ANKLE,
};
...
function coordinatesTouching(coordinates: number[], [x, y]: number[], error = [50, 50]) {
	return (
...
class Star {
	...
	isTouchingCoordinates(coordinates: number[], error = [50, 50]) {
		return (
